...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "/",
    // Machine readers get the settlements without scraping a table.
    types: { "application/feed+json": `${SITE}/feed.json` },
  },
  ...
  return (
    <html lang="en" className={inter.variable}>
      <body className="flex min-h-screen flex-col">
        ...
        {/* Mounted once at the root so ⌘K answers on every route, including the
            404 and the detail pages. */}
        <Suspense fallback={null}>
          <CommandPalette />
        </Suspense>
      </body>
